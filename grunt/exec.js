module.exports = {
    ...
    deploy: 'rsync -az --exclude=".DS_Store" -e "ssh -p 666" ./dist/ root@91.121.26.12:/home/kinoulink/app/webapp/',
    run_phonegap_android: 'cd <%= yeoman.phonegap %>  && cordova run android --device',
